...
public class SMSCALLReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (intentExtras != null) {
            ...
            if(isUrgent(smsBody) && MainActivity.silentOrNot==true){
                sendSMS = SmsManager.getDefault();
                if(MainActivity.callOrMeeting.equals("Class")){
                    sendSMS.sendTextMessage(address,null,"User Is In The Class, Will Call You After Class", null,null);
                }
                else{
                    sendSMS.sendTextMessage(address,null,"User Is In The Meeting, Will Call After Meeting", null,null);
                }
